...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '212.109.198.121', '0.0.0.0']
...
MIDDLEWARE = [
    ...
    'blog.middleware.CORSMiddleware', # CORS
...
DJOSER = {
    ...
    'USERNAME_RESET_CONFIRM_URL': FRONTEND_URL + '/username/reset/confirm/{uid}/{token}',
